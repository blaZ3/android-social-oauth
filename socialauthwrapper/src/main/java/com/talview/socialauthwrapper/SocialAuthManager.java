package com.talview.socialauthwrapper;
...
import com.talview.socialauthwrapper.WebVIewClients.FacebookWebViewClient;
import com.talview.socialauthwrapper.WebVIewClients.GitHubWebViewClient;
import com.talview.socialauthwrapper.WebVIewClients.LinkedInWebViewClient;
import com.talview.socialauthwrapper.WebVIewClients.StackOverFlowWebViewClient;
import com.talview.socialauthwrapper.WebVIewClients.TwitterWebViewClient;
import com.talview.socialauthwrapper.WebVIewClients.WebViewClientCallback;
...
public class SocialAuthManager {
    ...
    WebViewClientCallback webViewClientCallback = new WebViewClientCallback() {
        ...
        public void execute(String result) {
            ...
            dialog.dismiss();
            socialAuthInterface.authCallback(true, result);
        }
    };
...
//                map.put("oauth_token", ""); //not applicable for request_token
    ...
    public interface SocialAuthInterface{
        public void authCallback(boolean success,Object result);
    }
