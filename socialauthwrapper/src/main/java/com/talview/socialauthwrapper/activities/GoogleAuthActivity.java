...
public class GoogleAuthActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GOOGLE_CALLBACK_URL = intent.getStringExtra(SocialAuthConstants.CALLBACK_URL);
    ...
    private WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            if ((url != null) && (url.startsWith(GOOGLE_CALLBACK_URL))) { // Override webview when user came back to CALLBACK_URL
                Log.i("CALLBACK:", url);
                ...
                (new AsyncTask<Void, Void, Token>() {
                    ...
                    protected void onPostExecute(Token accessToken) {
                        ...
                        output.putExtra(SocialAuthConstants.ACCESS_TOKEN, accessToken.getToken());
