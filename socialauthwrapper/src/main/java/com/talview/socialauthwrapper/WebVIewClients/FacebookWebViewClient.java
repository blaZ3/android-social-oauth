...
public class FacebookWebViewClient extends WebViewClient {
    ...
    public FacebookWebViewClient(@NonNull Activity _activity, @NonNull String _callbackURL,
        ...
        activity                = _activity;
        FACEBOOK_CALLBACK_URL = _callbackURL;
    ...
    public void onPageFinished(WebView view, String url) {
        if ((url != null) && (url.startsWith(FACEBOOK_CALLBACK_URL))) { // Override webview when user came back to CALLBACK_URL
            ...
            final String request_token_url = "https://graph.facebook.com/oauth/access_token";

            Ion.with(activity)
                    .load(request_token_url)
                    .setBodyParameter("client_id", app_id)
                    .setBodyParameter("redirect_uri", FACEBOOK_CALLBACK_URL)
